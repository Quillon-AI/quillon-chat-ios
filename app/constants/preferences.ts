...
const Preferences = {
    ...
    THEMES: {
        ...
        quillon: {
            ...
            sidebarBg: '#0d0e10',
            sidebarText: '#f4f4f5',
            sidebarUnreadText: '#f4f4f5',
            sidebarTextHoverBg: '#191a1e',
            sidebarTextActiveBorder: '#5e6ad2',
            sidebarTextActiveColor: '#f4f4f5',
            sidebarHeaderBg: '#08090a',
            sidebarHeaderTextColor: '#f4f4f5',
            sidebarTeamBarBg: '#08090a',
            onlineIndicator: '#3db887',
            awayIndicator: '#f5ab00',
            dndIndicator: '#f87171',
            mentionBg: '#5e6ad2',
            mentionColor: '#ffffff',
            centerChannelBg: '#08090a',
            centerChannelColor: '#f4f4f5',
            newMessageSeparator: '#5e6ad2',
            linkColor: '#6e7ae2',
            buttonBg: '#5e6ad2',
            buttonColor: '#ffffff',
            errorTextColor: '#f87171',
            mentionHighlightBg: '#2d3178',
            mentionHighlightLink: '#a8b4ff',
            codeTheme: 'solarized-dark',
        },
