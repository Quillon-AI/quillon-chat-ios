...
const detoxConfig = detoxConfigTemplate.replace(/__DEVICE_NAME__/g, deviceName).replace(/__DEVICE_OS_VERSION__/g, deviceOSVersion).replace(/__AVD_NAME__/g, avdName);
